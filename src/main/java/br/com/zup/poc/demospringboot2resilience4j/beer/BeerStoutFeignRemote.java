...
import br.com.zup.poc.demospringboot2resilience4j.remote.BeerInfoFeignRemote;
...
@Component("feign")
public class BeerStoutFeignRemote implements BeerRemote {
    ...
    @Autowired
    private BeerInfoFeignRemote beerInfoRemote;

    public BeerStoutFeignRemote(CircuitBreakerRegistry circuitBreakerRegistry) {
    ...
    public List<Beer> findBeers() {
        Callable<List<Beer>> retryCallable = Retry.decorateCallable(retry, () -> beerInfoRemote.findBeers("stouts"));
